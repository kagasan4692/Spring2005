...
public class RunHtml {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePathHtml = "transactions.html";
        HtmlFileHandler htmlHandler = new HtmlFileHandler(filePathHtml);

        if (fileChecker(filePathHtml)) {
            ...
            if (checkEnteredInt(scanner, yesNoListInfo)) {
                ...
                if (checkEnteredInt(scanner, yesNoReadListInfo)) {
                    ...
                    System.out.println(htmlHandler.readListTransactions());
                ...
                System.out.println(htmlHandler.readMonthlyReport());
            }
        } else {
